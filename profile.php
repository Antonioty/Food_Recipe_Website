...
$getid = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM user WHERE username = '$user'"));
...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($imageExtension, $validExtension)) {
        ...
        if ($q1) {
            // Get the user ID of the inserted recipe
        ...
        <div class="container">
            <div class="row p-3">
                ...
                <div class="col-lg-3 text-center p-3">
                    <img src="img/<?php echo $getid["profpic"]; ?>
                </div>
                ...
                <div class="col-lg-9">
                    <div class="row">
                        ...
                        if (mysqli_num_rows($rows) > 0) {
                            foreach ($rows as $img) : ?>
                                <div class="col-6 col-md-6 col-lg-2 px-3" onclick="location.href='recipe.php'">
                                    <div class="card text-center">
                                        <img src="img/<?php echo $img['recipe_img']; ?>" title="<?php echo $img['recipe_img']; ?>">
                                        <div class="card-body">
